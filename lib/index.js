	...
	_createClass(TinyMCEInput, [{
		...
		value: function render() {
			...
			var _props = this.props,
			    ...
			    rest = _objectWithoutProperties(_props, ['className', 'input', 'isRequired', 'label', 'meta', 'options', 'resource', 'source', 'type', 'config', 'plugins', 'toolbar', 'menubar']);
			...
			return _react2.default.createElement(_reactTinymce2.default, _extends({
				...
				className: className,
				config: _extends({ plugins: plugins, menubar: menubar, toolbar: toolbar }, options),
				content: value
...
TinyMCEInput.propTypes = {
	...
	toolbar: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.bool, _propTypes2.default.array]),
